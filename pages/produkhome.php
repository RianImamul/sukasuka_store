...
$query = $conn->query("SELECT * FROM produk_sepatu");
if (!$query) {
...
<div class="container mt-5">
  <div class="judul-produk bg-white p-2 mb-3">
    <h5 class="text-center fw-bold mt-1">SEMUA PRODUK</h5>
  </div>
  <div class="row">
    <?php while($row = $query->fetch_assoc()): 
      $merek = strtolower($row['merek']);
      $gambarPath = "../assets/{$merek}/" . $row['gambar'];
    ?>
      <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
        <div class="card h-100 text-center">
          <img src="<?= $gambarPath ?>" class="card-img-top" style="height:180px; object-fit:cover;" alt="<?= $row['nama_produk'] ?>">
